...
import usersAvatarExapleImg from '../assets/users-avatar-example.png'
...
export default function Home(props: HomeProps) {
    ...
    async function createPool(event: FormEvent) {
        ...
        try {
            ...
            alert('Bolão criado com sucesso, o código foi copiado para a área de transferências!')

            setPoolTitle('')
        }
        catch (err) {
            console.log(err);
            alert('Falha ao criar o bolão, tente novammente mais tarde!')
        }
    }
                ...
                <div className='mt-10 flex items-center gap-2'>
                    ...
                    <form onSubmit={createPool} className='mt-10 flex'>
                        <input
                            ...
                            type="text"
                            required
                            placeholder='Qual é nome do seu bolão?'
